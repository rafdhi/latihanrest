...
public class BrandController {
	...
	@ApiOperation(
			  value = "API to retrieve all Brand data",
	...
	@ApiOperation(
			  value = "API to retrieve Brand data by nid",
			  notes = "Return data with JSON Format",
			  tags = "Get Data API")
	...
	@ApiOperation(
			  value = "API to insert Add Brand data",
			  notes = "Add brand data to database",
